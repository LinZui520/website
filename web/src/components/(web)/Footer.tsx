...
const Footer = () => {
  return (
    <div className={"h-[512px] w-ful sticky bottom-0 bg-[#1d1d1f] flex flex-col items-center"}>
      ...
      <div className={"h-[152px] w-full flex flex-col-reverse lg:flex-row justify-between items-start lg:items-center"}>
        ...
        <div className={"flex flex-col-reverse lg:flex-row justify-between items-start lg:items-center ml-[32px] lg:ml-[75px]"}>
          <a
          ...
          <div className={"flex flex-row mr-[75px] ml-0 lg:ml-[32px] mt-[32px] lg:mt-0"}>
            <a rel="noopener noreferrer" target="_blank" href="https://mail.google.com/mail/u/0/#search/yangminghe20@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" width="14" height="14"
            ...
            <a rel='noopener noreferrer' target='_blank' href='https://github.com/LinZui520/Website'>
              <svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width="14" height="14"
